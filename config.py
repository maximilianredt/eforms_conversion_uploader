...
GADS_TRIAL_START_ACTION = os.environ.get('GADS_TRIAL_START_ACTION', 'Trial Start')
GADS_MONTHLY_SUB_ACTION = os.environ.get('GADS_MONTHLY_SUB_ACTION', 'Monthly Subscription')
GADS_YEARLY_SUB_ACTION = os.environ.get('GADS_YEARLY_SUB_ACTION', 'Yearly Subscription')
GADS_DOC_PURCHASE_ACTION = os.environ.get('GADS_DOC_PURCHASE_ACTION', 'Document Purchase')
GADS_CHAT_PURCHASE_ACTION = os.environ.get('GADS_CHAT_PURCHASE_ACTION', 'Chat Purchase')
...
MS_CUSTOMER_ID = os.environ.get('MS_CUSTOMER_ID')

# Microsoft Ads conversion goal names
MSADS_TRIAL_START_GOAL = os.environ.get('MSADS_TRIAL_START_GOAL', 'Trial Start')
MSADS_MONTHLY_SUB_GOAL = os.environ.get('MSADS_MONTHLY_SUB_GOAL', 'Monthly Subscription')
MSADS_YEARLY_SUB_GOAL = os.environ.get('MSADS_YEARLY_SUB_GOAL', 'Yearly Subscription')
MSADS_DOC_PURCHASE_GOAL = os.environ.get('MSADS_DOC_PURCHASE_GOAL', 'Document Purchase')
MSADS_CHAT_PURCHASE_GOAL = os.environ.get('MSADS_CHAT_PURCHASE_GOAL', 'Chat Purchase')
